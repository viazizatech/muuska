...
<html>
    ...
    <body>
        <div class="container">
            <header>
                <h1> Ajout d'une nouvelle bibliothèque</h1>
            </header>
            <?php if(!empty($errors)):?>
            <ul class="errors">
            ...
            <form method="post" action="index.php?controller=association&action=processForm">
                <h2 class="form-title">Library Information</h2>
                
                <div class="form-body">
                    <div class="field_parent_block required<?php if(isset($formErrors['name'])): echo ' has-error'; endif;?>">
                        <label><!--<span class="required-span">*</span>--> Library name:</label>
                    ...
                    <div class="field_parent_block required<?php if(isset($formErrors['townName'])): echo ' has-error'; endif;?>">
                        <label>Town name:</label>
                        <div class="input_block">
                            <input type="text" name="townName" value="<?php if(isset($submittedData['townName'])): echo $submittedData['townName']; endif;?>">
                            <span class="error"><?php if(isset($formErrors['townName'])): echo $formErrors['townName']; endif;?></span>
                        </div>
                    </div>
