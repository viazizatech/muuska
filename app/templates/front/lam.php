  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">MuusKa</a></h1>
    ...
    <div class="container position-relative aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Muuska</h1>
          <h2>your new php framework, coming soon</h2>
        </div>
      </div>
  ...
  <main id="main">
    ...
    <section id="clients" class="clients section-bg">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center aos-init aos-animate" data-aos="zoom-in">
    ...
    <section id="testimonials" class="testimonials">
      <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="testimonials-slider swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events aos-init" data-aos="fade-up" data-aos-delay="100">
          <div class="swiper-wrapper" id="swiper-wrapper-e5c9172738ca10291" aria-live="off" style="transform: translate3d(-4290px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev" role="group" aria-label="8 / 11" style="width: 695px; margin-right: 20px;" data-swiper-slide-index="4">
            ...
            <div class="swiper-slide swiper-slide-duplicate-active" role="group" aria-label="4 / 11" style="width: 695px; margin-right: 20px;" data-swiper-slide-index="0">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide" role="group" aria-label="5 / 11" style="width: 695px; margin-right: 20px;" data-swiper-slide-index="1">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide" role="group" aria-label="6 / 11" style="width: 695px; margin-right: 20px;" data-swiper-slide-index="2">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide" role="group" aria-label="7 / 11" style="width: 695px; margin-right: 20px;" data-swiper-slide-index="3">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide swiper-slide-prev swiper-slide-duplicate-next" role="group" aria-label="8 / 11" style="width: 695px; margin-right: 20px;" data-swiper-slide-index="4">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Quis quorum aliqua sint quem legam fore sunt eram irure aliqua veniam tempor noster veniam enim culpa labore duis sunt culpa nulla illum cillum fugiat legam esse veniam culpa fore nisi cillum quid.
          ...
          <div class="swiper-slide swiper-slide-duplicate swiper-slide-active" role="group" aria-label="4 / 11" style="width: 695px; margin-right: 20px;" data-swiper-slide-index="0">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper.
    ...
    <section id="portfolio" class="portfolio">
      <div class="container aos-init" data-aos="fade-up">
        ...
        <div class="row portfolio-container aos-init" data-aos="fade-up" data-aos-delay="300" style="position: relative; height: 1507.81px;">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web" style="position: absolute; left: 359.985px; top: 0px;">
            <div class="portfolio-wrap">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app" style="position: absolute; left: 359.985px; top: 255.283px;">
            <div class="portfolio-wrap">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card" style="position: absolute; left: 0px; top: 370.61px;">
            <div class="portfolio-wrap">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web" style="position: absolute; left: 359.985px; top: 474.271px;">
            <div class="portfolio-wrap">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app" style="position: absolute; left: 0px; top: 622.783px;">
            <div class="portfolio-wrap">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card" style="position: absolute; left: 359.985px; top: 1006.52px;">
            <div class="portfolio-wrap">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card" style="position: absolute; left: 0px; top: 1152.43px;">
            <div class="portfolio-wrap">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web" style="position: absolute; left: 359.985px; top: 1254.61px;">
            <div class="portfolio-wrap">
    ...
    <section id="pricing" class="pricing">
      <div class="container aos-init" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 aos-init" data-aos="zoom-im" data-aos-delay="100">
            <div class="box">
              <h3>Free</h3>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0 aos-init" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-lg-0 aos-init" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              <h3>Developer</h3>
